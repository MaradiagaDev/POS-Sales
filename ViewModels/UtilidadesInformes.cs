...
namespace NeoCobranza.ViewModels
{
    internal static class UtilidadesInformes
    {
        ...
        public static void CargarInformeVentasSolo(string SucursalId, DateTime FechaInit, DateTime FechaFin)
        {
            try
            {
                //\\InformeEquiposTotales.xlsx"
                ...
                string rutaArchivo = Path.Combine(carpetaExcel, "ReporteSoloVentas.xlsx");
